...
import 'package:shopup/features/authentication/screens/reset_passrword.dart';
      ...
      body:  Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            //Text Fields,
            TextFormField(
              decoration: const InputDecoration( floatingLabelBehavior: FloatingLabelBehavior.never, labelText: TTexts.email, prefixIcon: Icon(Iconsax.direct_right)),
            ),
